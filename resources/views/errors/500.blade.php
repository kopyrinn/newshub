...
<body>
    ...
    <div class="content overflow-hidden py-0 px-0 px-sm-4">
        <div class="mb-0">
            ...
            <h2>Ошибка 503</h2>
            <div class="error-details" style="padding-bottom: 30px;">
            ...
            <div class="content py-4">
                <div class="row items-push fs-sm border-bottom pt-4">
                    <div class="col-md-6">
                        ...
                        <h4>{{ __("Follow Us") }}</h4>
                         <a  href="{{ nova_get_setting('facebook_url') }}" target="_blank"><i class="fab fa-facebook me-2" style="font-size: 24px;"></i></a>
                        <a href="{{ nova_get_setting('twitter_url') }}" target="_blank"><i class="fab fa-twitter me-2" style="font-size: 24px;"></i></a>
                        <a href="{{ nova_get_setting('instagram_url') }}" target="_blank"><i class="fab fa-instagram me-2" style="font-size: 24px;"></i></a>
                        <a href="{{ nova_get_setting('vk_url') }}" target="_blank"><i class="fab fa-vk me-2" style="font-size: 24px;"></i></a>
                        <a href="{{ nova_get_setting('telegram_url') }}" target="_blank"><i class="fab fa-telegram me-2" style="font-size: 24px;"></i></a>
                        <a href="{{ nova_get_setting('youtube_url') }}" target="_blank"><i class="fab fa-youtube me-2" style="font-size: 24px;"></i></a>
                    ...
                    <div class="col-sm-6 col-md-3">
                        ...
                        <ul class="list list-simple-mini">
                            ...
                            <li>
                                <a class="fw-semibold" href="{{ url('page/advertpage') }}">
...
<span id="_zero_73840">
  <noscript>
    <a href="http://zero.kz/?s=73840" target="_blank">
      <img src="http://c.zero.kz/z.png?u=73840" width="88" height="31" alt="ZERO.kz" />
    </a>
  </noscript>
</span>
