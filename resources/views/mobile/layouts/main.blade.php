...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('massets/img/icon/192x192.png') }}">
...
<div class="kurs">
        <div class="kurs_content">
            <ul class="kurs_content-list">
                <li class="kurs_content-item">
                    <img loading="lazy" class="kurs_money_img" src="/assets/usd.svg" alt="USD">
                        <span id="money_usd" class="kurs_value">0.0</span>
                </li>
                   
                <li class="kurs_content-item">
                    <img loading="lazy" class="kurs_money_img" src="/assets/eur.svg" alt="EURO">
                        <span id="money_euro" class="kurs_value">0.0</span>
                </li>
                    
                <li class="kurs_content-item">
                    <img loading="lazy" class="kurs_money_img" src="/assets/rub.svg" alt="RUB">
                        <span id="money_rub" class="kurs_value">0.0</span>
                </li>
            </ul>
        </div>
</div>
    ...
    <script src="https://newshub.kz/assets/js/lib/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="{{ asset('massets/js/lib/bootstrap.min.js') }}"></script>
    <!-- Ionicons -->
    <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    <!-- Splide -->
    <script src="{{ asset('massets/js/plugins/splide/splide.min.js') }}"></script>
    <!-- ProgressBar js -->
    <script src="{{ asset('massets/js/plugins/progressbar-js/progressbar.min.js') }}"></script>
    <!-- Base Js File -->
    <script src="{{ asset('massets/js/base.js') }}"></script>
