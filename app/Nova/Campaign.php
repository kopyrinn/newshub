        ...
        return [
            ...
            Panel::make(__('Conditions'), [
                ...
                DependencyContainer::make([
                    Boolean::make(__('Остаток времени по тарифу'), 'has_package_expires')
                        ->hideFromIndex()
                        ->help(__('Используется для создания условия по дате окончания тарифа пользователей')),

                    DependencyContainer::make([
                        Select::make(__('Остаток тарифа <='), 'package_gte')
                            ->options([
                                '1d' => __('<= 1 день'),
                                '1w' => __('<= 1 неделя'),
                                '2w' => __('<= 2 недели'),
                            ...
                            ->displayUsingLabels(),
                        Select::make(__('Остаток тарифа >='), 'package_lte')
                            ->options([
                                '1d' => __('>= 1 день'),
                                '1w' => __('>= 1 неделя'),
                                '2w' => __('>= 2 недели'),
                            ...
                            ->displayUsingLabels(),
                    ])->dependsOn('has_package_expires', true),
                ])->dependsOn('package_state', 'active'),
