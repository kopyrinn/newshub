        ...
        \Outl1ne\NovaSettings\NovaSettings::addSettingsFields([
            Panel::make('Основные', [
                ...
                Boolean::make('Траурный режим (чёрно-белый сайт)', 'mourning_mode')
                    ->default(false)
                    ->help('Включает чёрно-белое отображение и обязательную тёмную тему для всех посетителей. Переключение на светлую тему недоступно, пока включён траурный режим. Открытые страницы обновятся автоматически примерно за минуту.'),
            ]),
            Panel::make('Цены', [
